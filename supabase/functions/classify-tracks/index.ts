...
const GENRE_SYNONYMS: Record<string, string[]> = {
  ...
  boleros: ["bolero", "boleros", "baladas y boleros"],
  pop_latino: ["pop latino", "latin pop", "latino", "pop en espanol"],
  rock: ["rock", "alternative rock", "grunge", "classic rock", "hard rock", "alternative", "alternativa", "alt rock", "rock and roll", "garage rock", "alternativa y rock en espanol"],
  ...
  arabic_pop: ["arabic pop", "khaleeji", "arab pop", "pop arabe"],
  ...
  nordic_pop: ["nordic pop", "scandipop", "swedish pop", "pop nordico"],
  country_folk: ["country", "folk", "americana", "singer-songwriter", "folk rock", "indie folk", "singer/songwriter", "singer songwriter"],
  classical: ["classical", "orchestral", "soundtrack", "clasica", "musica clasica", "crossover clasica", "bandas sonoras"],
  opera: ["opera", "aria"],
  ...
  celtic_irish: ["celtic", "irish folk", "irish traditional", "celta", "musica celta", "irlandesa"],
  fado: ["fado", "fado portugues"],
  gospel_cristiana: ["gospel", "christian", "musica cristiana", "cristiana", "cristiana y gospel", "inspiracion", "liturgica y religion", "musica espiritual"],
